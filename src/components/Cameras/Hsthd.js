...
export default function Hsthdhd() {
  const [query, setQuery] = useState("");
  const [hsthdData, sethsthd] = useState(null);

  useEffect(() => {
    sanityClient
      .fetch(
        `*[_type == "hst" &&feature8=="HD"]{
        title,
        feature1,
        feature2,
        feature3,
                  ...
                  <div className=" flex justify-between border-spacing-2">
                    ...
                    <button
                      ...
                      <div class="flex-col justify-center align-middle py-15">
                        ...
                        ${hsthd.feature1 ? `<li>${hsthd.feature1}</li>` : ""}
                      
                      ${hsthd.feature2 ? `<li>${hsthd.feature2}</li>` : ""}
                      ${hsthd.feature3 ? `<li>${hsthd.feature3}</li> ` : ""}
                      ${hsthd.feature4 ? `<li>${hsthd.feature4}</li>` : ""}
                      ${hsthd.feature5 ? `<li>${hsthd.feature5}</li>` : ""}
                      ${hsthd.feature6 ? `<li>${hsthd.feature6}</li>` : ""}
                      ${hsthd.feature7 ? `<li>${hsthd.feature7}</li>` : ""}
                      ${hsthd.feature8 ? `<li>${hsthd.feature8}</li>` : ""}
                      ${hsthd.feature9 ? `<li>${hsthd.feature9}</li>` : ""}
                      ${hsthd.feature10 ? `<li>${hsthd.feature10}</li>` : ""} 
                      ${hsthd.feature11 ? `<li>${hsthd.feature11}</li>` : ""} 
                      ${hsthd.feature12 ? `<li>${hsthd.feature12}</li>` : ""} 
                      ${hsthd.feature13 ? `<li>${hsthd.feature13}</li>` : ""} 
                      ${hsthd.feature14 ? `<li>${hsthd.feature14}</li>` : ""} 
                      ${hsthd.feature15 ? `<li>${hsthd.feature15}</li>` : ""} 
                      </ul>
                      </div>
                    </div>`;
                      }}
